...
export const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "MCP", icon: "mcp", color: "#D97757" },
...
export const projects: Project[] = [
  {
    title: "Focus Flow",
    description:
      "Focus Flow is your all in one companion for getting things done with purpose. It brings together a Pomodoro style focus timer, goal setting, habit tracking, daily reflections, and a simple dashboard that shows you everything at a glance. Focus. Build . Reflect. Grow, one session at a time.",
    tags: ["Mern Stack", "Tailwind CSS v4", "TypeScript"],
    liveUrl: "#not-live-yet",
    repoUrl: "https://github.com/Najib-Rahmi/FocusFlow",
    accent: "from-cyan-500/20 to-blue-500/20",
    image: "/FocusFlow.webp",
    isPrivate: false,
  },
  {
    title: "PFE Portal",
    description:
      "A  platform managing the full project submission lifecycle for Students, Supervisors, and Administrators. Implemented a multi-stage pipeline (Draft → Submitted → Under Review → Approved/Rejected) with service-layer logic in Laravel, plus role-based dashboards with real-time status tracking",
    tags: ["React", "Node.JS", "TypeScript", "Tailwind CSS"],
    liveUrl: "",
    repoUrl: "",
    accent: "from-blue-500/20 to-cyan-500/20",
    image: "/PFE_Portal.webp",
    isPrivate: true,
  },
  {
    title: "Employees Management System",
    description:
      "Employees Management System is a comprehensive solution designed to streamline employee management, track workforce data, organize departments, monitor attendance, manage roles and permissions, and improve overall organizational efficiency through a centralized and user-friendly platform.",
    tags: ["React", "Vite", "Tailwind CSS", "JavaScript"],
    liveUrl: "",
    repoUrl: "",
    accent: "from-blue-500/20 to-cyan-500/20",
    image: "/EmployeesManagement.webp",
    isPrivate: true,
  },
  {
    title: "Weather App",
    description:
      "A weather application built with React 19, Vite, and Tailwind CSS v4. Features real-time weather data, 5-day forecasts, geolocation support, and dynamic backgrounds that adapt to weather conditions. Glass morphism UI with a seamless user experience.",
    tags: ["React 19", "Vite", "Tailwind CSS v4", "API"],
    liveUrl: "https://weatherapp2026.vercel.app",
    repoUrl: "https://github.com/Najib-Rahmi/Weather",
    accent: "from-cyan-400/20 to-blue-600/20",
    image: "/RainBackground.webp",
    isPrivate: false,
  },
  {
    title: "Music Player",
    description:
      "A React music player with real MP3 playback, custom album artwork, and advanced controls. Built with React 19, Vite, and Tailwind CSS v4.",
  ...
  },
  {
    title: "To-Do App",
    description:
      "A Todo app built with React, Vite, and Tailwind CSS. Features drag-and-drop task reordering, a dark gradient theme, and a modular component architecture for seamless task management.",
    tags: ["React", "Vite", "Tailwind CSS", "JavaScript"],
    liveUrl: "#not-live-yet",
  ...
  },
  {
    ...
    description:
      "A scientific calculator built with React and Tailwind CSS as a personal project to sharpen my front end skills. It supports trigonometry, logarithms, roots, fractions, percentages, and calculation history, all wrapped in a clean, responsive interface built entirely with React and Tailwind.",
    ...
    image: "/ScientificCalculator.webp",
    isPrivate: false,
  },
  {
    title: "Random Quote Generator",
    description:
      "A simple app built with React to practice my front end development skills. It displays a random inspirational quote at the click of a button, pulling from a collection of quotes and authors, with options to copy or share your favorites.",
    tags: ["React", "Vite", "JavaScript"],
    liveUrl: "#not-live-yet",
    repoUrl: "https://github.com/Najib-Rahmi/Random-Quote-Generator",
    accent: "from-blue-500/20 to-cyan-400/20",
    image: "/Random-Quote-Generator.webp",
    isPrivate: false,
  },
];
...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    icon: HeartPulse,
    highlights: [
      "Officially documented medical leave from 3 February 2024 to 13 April 2026",
      "Fully recovered and actively returning to full stack development",
      "Stronger, more motivated, and ready to build again",
    ],
  },
  {
    role: "Full Stack Web Developer",
    ...
    icon: Briefcase,
    highlights: [
      "Built the full PFE submission and validation lifecycle, serving three role-scoped user types: Student, Supervisor, and Administrator",
