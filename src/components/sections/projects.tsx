...
export function Projects() {
  return (
    <section id="projects" className="relative py-20 sm:py-28 bg-background">
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 grid place-items-center">
                  <span className="text-6xl drop-shadow-lg transition-transform duration-500 group-hover:scale-125 group-hover:rotate-6">
                    {project.emoji}
                  </span>
                </div>
