    ...
    <section
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        ...
        <div className="mt-14 relative">
          {/* Vertical line */}
          <div className="absolute left-4 sm:left-1/2 top-0 bottom-0 w-px bg-linear-to-b from-transparent via-cyan-500/40 to-transparent sm:-translate-x-1/2" />
            ...
            {experiences.map((exp, i) => {
              ...
              return (
                <motion.div
                  ...
                  <span className="absolute left-4 sm:left-1/2 top-1.5 grid place-items-center size-9 -translate-x-1/2 rounded-full bg-linear-to-br from-cyan-500 to-blue-600 text-white shadow-lg shadow-cyan-500/30 ring-4 ring-background z-10">
